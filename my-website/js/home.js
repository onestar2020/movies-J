...
function watchCurrentBanner(event) {
  ...
  if (banner) {
    // 🔴 Optional safety: stop any iframe from playing
    const iframe = banner.querySelector("iframe");
    if (iframe) {
      iframe.src = "about:blank"; // Force unload iframe src
    }
