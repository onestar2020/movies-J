...
function populateServerSelector(item) {
    ...
    // Tanggalin lang ang nakakagulong CAM/Telesync badge sa Movies, panatilihin ang iba
    const badgeBox = document.getElementById("media-badges");
    if (badgeBox) {
    ...
    if (typeof STREAM_SERVERS !== "undefined") {
        ...
        serverKeys.forEach((key, index) => {
            ...
            // Malinis na pangalan lang ng server: Server 1, Server 2, atbp.
            ...
            btn.onclick = () => {
                ...
                // Inalis na nang tuluyan ang Video Quality Notice (CAM) modal dito!
